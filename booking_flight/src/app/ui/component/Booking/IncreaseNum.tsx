    ...
    return(
        <div className="flex items-center justify-between">
            ...
            <div className="border-2  flex-center flex-row text-slate-400 rounded-lg w-[100px] h-[40px]">
                <button type="button" onClick={Decrease}  className="w-[30px] h-[40px] border-r-2">-</button>
                <div className="w-[35px] h-full bg-slate-100 flex-center">{numberOfpeople}</div>
                <button type="button"  onClick={Increase} className="w-[30px] h-[40px] border-l-2">+</button>
            </div>
        </div>
    )
